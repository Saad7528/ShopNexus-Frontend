...
<body>
  <table>
    ...
    <tr>
      <td colspan="13" class="sub-banner">${filterTitle.toUpperCase()} • Generated: ${generatedAt} (${timeFilter.toUpperCase()}) • Live Traffic: ${liveCount} Active</td>
    </tr>
...
<body>
  ...
  <div style="margin-bottom: 20px;">
    <h1 style="color: #ff4400; font-family: sans-serif; margin-bottom: 4px;">ShopNexus - Telemetry Analytics Export</h1>
    <p style="color: #475569; font-family: sans-serif; font-size: 14px; margin: 2px 0;"><strong>Scope:</strong> ${filterTitle} | <strong>Window:</strong> ${timeFilter.toUpperCase()} | <strong>Live Traffic:</strong> ${liveCount} active visitors</p>
    <p style="color: #475569; font-family: sans-serif; font-size: 14px; margin: 2px 0;"><strong>Generated At:</strong> ${generatedAt} | <strong>Total Records:</strong> ${sessions.length}</p>
    <p style="color: #059669; font-family: sans-serif; font-size: 14px; margin: 2px 0;"><strong>Total Tracked Cart Value:</strong> ৳${totalCartValue.toLocaleString()}</p>
  </div>
