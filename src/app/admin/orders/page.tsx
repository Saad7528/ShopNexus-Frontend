      ...
      <div className="space-y-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-white">Orders & Invoicing Management</h1>
                ...
                {filteredOrders.map((ord) => (
                  <tr key={ord.id} className="hover:bg-slate-800/30 transition-colors">
                    <td className="px-5 py-3.5">
                      <span className="font-mono font-black text-indigo-300 block">{ord.orderNumber}</span>
                      <span className="text-[10px] text-slate-500 font-mono">{ord.createdAt}</span>
                    </td>
                    <td className="px-5 py-3.5">
                    ...
                    <td className="px-5 py-3.5 font-mono font-black text-white text-sm">
                      ৳{ord.total.toLocaleString()}
                    </td>
                    <td className="px-5 py-3.5">
                      <span className="px-2.5 py-1 rounded-full bg-slate-800 text-[10px] font-semibold text-slate-200 border border-slate-700">
                        {ord.paymentMethod}
                      </span>
                    </td>
                    <td className="px-5 py-3.5">
                    ...
                    <td className="px-5 py-3.5 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs border border-slate-700 transition-all cursor-pointer"
