      ...
      <div className="max-w-md w-full p-8 rounded-3xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-xl backdrop-blur-xl text-center space-y-4">
        {status === 'loading' && (
          <div className="space-y-4">
            ...
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Authenticating with GitHub...</h2>
            <p className="text-xs text-slate-600 dark:text-slate-400">Exchanging credentials and establishing secure session...</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="space-y-4 animate-in fade-in-50">
            ...
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">GitHub Sign-In Successful!</h2>
            <p className="text-xs text-slate-600 dark:text-slate-300">Welcome to ShopNexus. Redirecting to marketplace...</p>
          </div>
        )}
