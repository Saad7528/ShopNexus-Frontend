...
export default function LoginPage() {
  ...
  return (
    <AuthBackground>
      ...
      {/* Glassmorphic Solid Container */}
      <div className="w-full max-w-md bg-slate-900/75 backdrop-blur-sm border border-white/10 rounded-3xl p-7 sm:p-9 shadow-[0_20px_50px_rgba(0,0,0,0.6)] relative overflow-hidden space-y-5">
        ...
        {/* 1-Click Social Logins with Solid Glassy Surface */}
