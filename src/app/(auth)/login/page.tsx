...
import { ShieldCheck, Mail, Lock, ArrowRight, Loader2, Layers } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 backdrop-blur-xl rounded-3xl p-6 sm:p-8 shadow-2xl space-y-4">
          ...
          >
            {isOAuthLoading === 'google' ? (
              ...
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
                ...
                <path
                  fill="#4285F4"
                  d="M23.5 12.3c0-.8-.1-1.6-.2-2.3H12v4.6h6.5c-.3 1.5-1.1 2.8-2.4 3.7l3.7 2.9C23.5 12.3c0-.8-.1-1.6-.2-2.3H12v4.6h6.5c-.3 1.5-1.1 2.8-2.4 3.7l3.7 2.9z"
                />
                <path
                  fill="#FBBC05"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <Link
                ...
                className="text-[11px] font-semibold text-orange-600 dark:text-orange-400 hover:text-orange-500 transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-[#ff4400] via-[#ff7700] to-[#ff4400] hover:from-[#e63d00] hover:to-[#ff6600] text-white font-bold text-xs rounded-xl shadow-lg shadow-orange-500/25 transition-all duration-200 disabled:opacity-50 cursor-pointer mt-2"
          >
            {isLoading ? (
              <>
        ...
        <p className="text-center text-xs text-slate-500 dark:text-slate-400 pt-2">
          ...
          <Link href="/register" className="font-semibold text-orange-600 dark:text-orange-400 hover:underline">
            Create an account
          </Link>
        </p>
      </div>
