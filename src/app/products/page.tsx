...
function ProductsContent() {
  ...
  return (
    <div className="max-w-7xl lg:max-w-[85vw] xl:max-w-[85vw] min-[2560px]:max-w-[75vw] mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-10">
      {/* Header Banner */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <main className="lg:col-span-3 space-y-6">
          ...
          {products.length === 0 ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 min-[2400px]:grid-cols-6 gap-2.5 sm:gap-3.5">
