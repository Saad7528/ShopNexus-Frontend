        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-md mx-4">
              <div className="relative w-full flex items-center">
                ...
                <button
                  ...
                  className="absolute right-2 p-1.5 rounded-lg text-slate-400 hover:text-indigo-400 hover:bg-slate-800 transition-colors"
            ...
            <div className="flex items-center gap-2">
              {/* AI Visual Search Button (Mobile/Tablet) */}
              <button
                onClick={() => setVisualSearchOpen(true)}
                className="md:hidden p-2 rounded-xl bg-slate-900/70 border border-slate-800 text-slate-300 hover:text-indigo-400 transition-all"
