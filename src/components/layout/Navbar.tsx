          ...
          <div className="flex items-center justify-between h-16 sm:h-18 gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5">
              ...
              <button
                type="button"
                onClick={toggleTheme}
                className="inline-flex p-2 sm:p-2.5 rounded-xl bg-slate-100 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 text-slate-700 dark:text-slate-300 hover:text-orange-500 dark:hover:text-orange-300 transition-all cursor-pointer shadow-sm"
              ...
              <Link
                href="/wishlist"
                className="inline-flex relative p-2 sm:p-2.5 rounded-xl bg-slate-100 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 text-slate-700 dark:text-slate-300 hover:text-rose-500 transition-all group shadow-sm"
                title="View Wishlist"
              >
