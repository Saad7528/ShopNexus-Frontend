      ...
      >
        <div
          className={`pointer-events-auto mx-auto transition-all duration-300 ease-out ${isScrolled
              ...
              : 'w-full max-w-7xl lg:max-w-[85vw] xl:max-w-[85vw] min-[2560px]:max-w-[75vw] rounded-none bg-white dark:bg-[#090d16] border border-transparent border-b-slate-200/80 dark:border-b-slate-800/80 px-3 sm:px-6 lg:px-8 shadow-none'
            }`}
        >
          <div
