...
export function Skeleton({ className, ...props }: SkeletonProps) {
  return (
    <div
      className={cn(
        'relative overflow-hidden rounded-xl bg-slate-800/80 animate-shimmer',
        className
      )}
      {...props}
    />
...
/**
 * Single Product Card Skeleton (Matching Storefront Product Cards)
 */
export function ProductCardSkeleton() {
  return (
    <div className="group relative flex flex-col rounded-2xl border border-slate-800/80 bg-slate-900/60 p-4 backdrop-blur-md shadow-lg space-y-4">
      {/* Product Image Placeholder */}
      <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-slate-800/70 animate-shimmer">
        <div className="absolute top-2.5 left-2.5 h-5 w-16 rounded-full bg-slate-700/80 animate-shimmer" />
        <div className="absolute top-2.5 right-2.5 h-7 w-7 rounded-full bg-slate-700/80 animate-shimmer" />
      </div>
  ...
  return (
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="relative overflow-hidden rounded-2xl border border-slate-800/80 bg-slate-900/70 p-5 space-y-3 backdrop-blur-md"
        >
...
export function AdminTableSkeleton({ rows = 6, cols = 5 }: { rows?: number; cols?: number }) {
  return (
    <div className="space-y-4 rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 backdrop-blur-md">
...
export function TrackingTimelineSkeleton() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 space-y-8">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-8 space-y-4 backdrop-blur-md">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-8 space-y-8 backdrop-blur-md">
        ...
        {/* Courier / Rider Info */}
        <div className="rounded-2xl border border-slate-800/80 bg-slate-800/40 p-5 flex items-center justify-between">
...
export function ProfileVaultSkeleton() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      {/* Header Profile Card */}
      <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-8 backdrop-blur-md flex flex-col md:flex-row items-center justify-between gap-6">
